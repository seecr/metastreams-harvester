...
# Copyright (C) 2011-2014, 2017, 2019-2021, 2025 Seecr (Seek You Too B.V.) https://seecr.nl
# Copyright (C) 2011-2012, 2019-2021, 2025 Stichting Kennisnet https://www.kennisnet.nl
...
class OaiRequestTest(SeecrTestCase):
    ...
    def testHeaders(self):
        ...
        self.assertEqual(
            {"User-Agent": "User Agent 3.0"},
            OaiRequest(
                "http://example.com", headers={"User-Agent": "User Agent 3.0"}
            )._headers(),
        )
        ...
        self.assertEqual(
            ...
            OaiRequest(
                "http://example.com", headers={"Authorization": "Bearer GivenKey"}
            )._headers(),
        )
    ...
    def testMockOaiRequest(self):
        ...
        self.assertEqual(
            ...
            xpathFirst(response.response, "/oai:OAI-PMH/oai:responseDate/text()"),
        )
    ...
    def testListRecords(self):
        ...
        self.assertEqual(
            ...
            xpathFirst(response.records[0], "oai:header/oai:identifier/text()"),
        )
    ...
    def testListRecordArgs(self):
        ...
        self.request.listRecords(
            from_="from", until="until", set="set", metadataPrefix="prefix"
        )
        kwargs = dict(self.mockRequest_args)
        self.assertEqual(("verb", "ListRecords"), self.mockRequest_args[0])
    ...
    def testGetRecord(self):
        response = self.request.getRecord(
            identifier="oai:rep:12345", metadataPrefix="oai_dc"
        )
        self.assertEqual(
            "oai:rep:12345",
...
def oaiResponseXML(
    responseDate="2000-01-02T03:04:05Z",
    verb="ListRecords",
    identifier="oai:ident:321",
    deleted=False,
    about=None,
):
