...
class DeleteIdsActionTest(ActionTestCase):
    ...
    def testDelete(self):
        ...
        self.stats_path.write_text('Started: 2005-12-22 16:33:39, Harvested/Uploaded/Deleted/Total: 10/10/0/2, Done: ResumptionToken:\n')
        ...
        deletes = [m for m in self.uploader.calledMethods if m.name == "deleteIdentifier"]
